...
Return ONLY the improved content. No explanations or notes.'''
    ...
    def generate_introduction(self,
        ...
        try:
            ...
            prompt_parts = [
                "You are writing an introduction for a blog article. Write like a HUMAN explaining to another human, NOT like a technical manual or textbook.",
                "",
                gcore_editorial,
                "",
                f"Topic: {topic}",
                "",
                "CRITICAL: FORBIDDEN ROBOTIC PATTERNS (Do NOT use):",
                "- 'X is a Y that Z...' (formal textbook definition)",
                "- 'This solves a practical problem...'",
                "- 'The X works through...'",
                "- 'X refers to...'",
                "- 'This enables...'",
                "- 'Understanding X is important because...'",
                "- Starting every sentence with noun subjects",
                "- Overly formal, academic language",
                "",
                "REQUIRED HUMAN ELEMENTS:",
                "1. Use 'you' and 'your' to address readers directly",
                "2. Use contractions (it's, don't, you'll, there's, here's)",
                "3. Start sentences with: 'When', 'If', 'While', 'Because', 'Instead of'",
                "4. Use conversational phrases: 'here's how', 'the key thing', 'what matters'",
                "5. Write like you're explaining to a colleague over coffee",
                "6. Make it engaging and relatable, not dry and academic",
                "",
                "INTRODUCTION STRUCTURE:",
                "",
                "Paragraph 1 (2-3 sentences):",
                "- Start conversationally, addressing a real-world situation or question",
                f"- Example: 'When you type a website address into your browser, {topic.lower()} works behind the scenes to...'",
                f"- Or: 'If you've ever wondered how {topic.lower()} actually works, here's what happens...'",
                "- Define the concept naturally within the explanation",
                "",
                "Paragraphs 2-3 (2-3 sentences each):",
                "- Expand on key aspects using conversational language",
                "- Use real-world examples readers can relate to",
                "- Avoid textbook patterns - write like you're teaching a friend",
                "",
                "Final Paragraph (1-2 sentences):",
                "- Connect to why readers should care",
                "- Make it practical and relevant to their needs",
                "",
                "REQUIREMENTS:",
                "- Total: 4-5 paragraphs (200-300 words)",
            ...
            # Final instructions
            prompt_parts.extend([
                "WRITE THE INTRODUCTION NOW (remember: conversational, not academic!):",
                "",
                "GOOD INTRO EXAMPLE (natural, engaging):",
                f"'When you're working with {topic.lower()}, you'll quickly realize it's more than just [basic aspect]. It's actually [what it really does]. Here's how it works and why it matters for your infrastructure.'",
                "",
                "BAD INTRO EXAMPLE (robotic, avoid this):",
                f"'{topic.capitalize()} is a system that provides [definition]. This solves a practical problem by enabling [function]. The system works through [mechanism].'",
                "",
                "Format as 4-5 separate paragraphs with blank lines between them.",
                "Use contractions and 'you' throughout.",
                "Write like you're explaining to a colleague, not writing a manual.",
                "",
                # ADD BLACKLIST AT THE END - final reminder
                self.blacklist_prompt,
                ""
